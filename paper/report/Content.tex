...
network structures are employed in the article. 

\begin{figure}[H]
  \centering
  \includegraphics[width=0.3\textwidth, valign=t]{network_structure1}
  \includegraphics[width=0.3\textwidth, valign=t]{network_structure2}
  \includegraphics[width=0.3\textwidth, valign=t]{network_structure3}
  \caption{}
